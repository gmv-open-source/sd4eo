...
available_cities_IDs = ['Poitiers'] # 'Rouen']
...
if __name__ == "__main__":
    ...
    diff_steps = 50
    seed_ini = 0
    num_variations_same_map = 10
    init_num_variations = 0 # TODO: swap to ZERO later!
    model = model.cuda()
    ...
    for city_ID in available_cities_IDs:
        ...
        if ukserver2_flag:
            ...
            input_base_path = 'C:/DATASETs/UC2Synthesis/OSM.full/'
            output_path = f'C:/DATASETs/UC2Synthesis.v110/Synth{spec_str}/{city_ID}/'
