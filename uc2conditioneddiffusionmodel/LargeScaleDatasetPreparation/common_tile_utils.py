...
def provide_inner_tile_coords(tile_id):
    ...
    # Cities:
        ...
        icoords_EPGS3857 = (-58532.95,5838170.31, -43606.4,5824968.1)
        icoords_EPGS4326 = (46.3595999,-0.5257423, 46.2777445,-0.3916940)
        base_filename = ''        
        orig_tile_name = ''         
    # elif tile_id == 'Rouen':
    ...
    return icoords_EPGS3857, icoords_EPGS4326, base_filename, orig_tile_name
